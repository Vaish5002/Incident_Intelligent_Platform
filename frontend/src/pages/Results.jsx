...
const Results = () => {
  ...
  const handlePdfDownload = async () => {
    ...
    try {
      // Trigger GET /download-pdf mock endpoint
      const response = await api.downloadPdf(activeIncidentId);
      ...
      setTimeout(() => {
        ...
        // Trigger simulated file download alert / download
        const dummyContent = `RCA REPORT FOR ${activeIncident.id}\nDownload code: ${response.downloadUrl}`;
      ...
      setDownloading(false);
      alert(err.message || 'Failed to request PDF download endpoint.');
    }
  };
